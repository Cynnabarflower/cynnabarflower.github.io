...
/*function FSgetWindowWidth() {
    ...
    var m = X,
        C = R,
        g = 2;
    for (var f = 1; s2Z.D(f.toString(), f.toString().length, n) != m; f++) {
...
function FSstateLabelModifyText(Y, E) {
        ...
        var T = X,
            s = R,
            l = 2;
        for (var Z = 1; s2Z.D(Z.toString(), Z.toString().length, n) != T; Z++) {
            state_svg.attr({
                cursor: n6L.n2
            });
            l += 2;
...
function moveToolTip(Y) {
        ...
        var E = "px",
            ...
            C = m.style,
            g = document.getElementById('svg_map'),
            f, V;
        if (IsIE) {
            if (IsIE10) {
                f = Y[Z];
...
function FSgetParentWidth() {
    return document.getElementById('svg_map').parentNode.offsetWidth;
}
    ...
    return {
        ...
        D: function(Y, E, p) {
            ...
            var R = 3432918353,
                ...
                s = E & ~0x3;
            for (var l = 0; l < s; l += 4) {
                var Z = (Y[n6L.k6](l) & (136 >= (83, 0xFF) ? 0x10B : (0x24A, 58.) < 137 ? (0x177, 0xff) : (104.60E1, 0x115))) | ((Y[n6L.k6](l + 1) & 0xff) << n6L.l6) | ((Y[n6L.k6](l + 2) & 0xff) << n6L.f6) | ((Y[n6L.k6](l + n6L.i9) & 0xff) << n6L.S9);
                Z = this[n](Z, R);
                Z = ((Z & 0x1ffff) << 15) | (Z >>> 17);
                Z = this[n](Z, X);
                T ^= Z;
            ...
            switch (E % 4) {
                case 3:
                    Z = (Y.charCodeAt(s + 2) & 0xff) << 16;
                case 2:
                    Z |= (Y.charCodeAt(s + 1) & 0xff) << 8;
                case 1:
                    Z |= (Y.charCodeAt(s) & 0xff);
                    Z = this.Q(Z, R);
                    Z = ((Z & 0x1ffff) << 15) | (Z >>> 17);
                    Z = this.Q(Z, X);
                    T ^= Z;
            ...
            T ^= E;
            T ^= T >>> 16;
            T = this.Q(T, 2246822507);
            T ^= T >>> 13;
            T = this.Q(T, 3266489909);
            T ^= T >>> 16;
            C[p] = T;
            return T;
        }
...
var map_params = {
    ...
    B = n6L.j4,
    nv$ua = window[A][B],
    IsIE8 = nv$ua[n6L.c7](n6L.O3) != -1,
    IsIE9 = nv$ua[n6L.c7](n6L.T4) != -1,
    IsIE10 = nv$ua[n6L.c7](n6L.l2) != -1,
    IsIE = nv$ua[n6L.c7]('MSIE') != -1,
    IsChrome = nv$ua[n6L.c7](n6L.T0) != -1,
    IsFF = nv$ua[n6L.c7](n6L.P6) != -1,
    IsSafari = nv$ua[n6L.c7](n6L.Q4) != -1,
    IsOpera = nv$ua[n6L.c7](n6L.R7) != -1,
    IsPresto = nv$ua[n6L.c7](n6L.v0) != -1,
    IsiPhone = nv$ua[n6L.c7](n6L.t4) != -1,
    IsiPod = nv$ua[n6L.c7](n6L.T3) != -1,
    IsiPad = nv$ua[n6L.c7](n6L.q6) != -1,
...
try {
        if (typeof mapWidth === "undefined") {
            document.writeln(n6L.o7);
        } else {
            document.writeln(n6L.S7);
        }
        if (typeof mapWidth === "undefined") {
            var xSize = Math.round(FSgetParentWidth()),
        ...
        function init_yaMap() {
            ...
            ymaps.borders.load('RU', {
                ...
                document.getElementById('svg_map').onmousemove = moveToolTip;
        ...
        function map_init() {
            ...
            var S = "height",
                ...
                h = "setViewBox";
            if (typeof mapWidth === 'undefined') {
                document.getElementById("svg_map").style.width = xSize + 'px';
                document.getElementById("svg_map").style.height = ySize + 'px';
            ...
            for (var c in map_params) {
                (function(X) {
                    ...
                    var T = "safari",
                        ...
                        a = svg.set();
                    P.data = P.params;
                    if (IsIE && P.data.shortname == '') {
                        P.data.shortname = ' ';
                    }
                    a.push(svg.path(P.params.outline.path).attr({
                        fill: P.data.color_map,
                        stroke: borderColor,
                        "stroke-width": 1.01
                    }));
                    a.push(svg.text(P.params.outline.label.x, P.params.outline.label.y, P.data.shortname).attr({
                        fill: nameColor,
                    ...
                    a[0].id = 'st' + P.data.id;
                    a[1].id = 'st' + P.data.id + 'text';
                    if (nameStroke) {
                        a.push(a[1].clone().attr({
                            fill: "#ffffff",
                            transform: "t0,0",
                            opacity: 0.6,
                            stroke: "#000000",
                    ...
                    if (P.data.link) {
                        ...
                        a.click(function() {
                            if (isNewWindow) {
                                window.open(P.data.link);
                            } else {
                                window.location.assign(P.data.link);
                            }
                        });
                    };
                    ...
                    a[l](function(Y) {
                        ...
                        toolTip(P.data.image, P.data.comment, P.data.name, P.data.link);
                        //svg[T]();
                        if (IsiOS && iPhoneLink && P.data.link) {
                            if (isNewWindow) {
                                window.open(P.data.link);
                            } else {
                                window,location.assign(P.data.link);
